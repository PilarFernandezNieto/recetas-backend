...
return [
    ...
    | las reglas de tamaño. Siéntete libre de modificar estos mensajes aquí.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de Lenguaje de Validación de Personalización
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar tus propios mensajes de validación para atributos usando
    | el formato "attribute.rule" para personalizar las reglas. De esta manera,
    | puedes cambiar fácilmente el mensaje de un atributo específico.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar los nombres de los atributos que se utilizarán en las
    | líneas de lenguaje de validación. Esto te permite reemplazar los nombres
    | de atributos con algo más amigable, como "Dirección de correo electrónico"
    | en lugar de "email".
    |
    */
